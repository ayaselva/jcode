...
# OpenAI service tier override (priority|flex|off|auto)
# Defaults to `auto`/standard. Set to "priority" (or use /fast on) only when you want
# the faster, higher-usage tier for the current session or saved default.
